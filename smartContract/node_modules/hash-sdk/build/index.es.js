...
import { ContractFunctionParams, Client, Ed25519PrivateKey, FileCreateTransaction, FileAppendTransaction, ContractCreateTransaction, Mnemonic, AccountBalanceQuery, CryptoTransferTransaction, Status, ContractExecuteTransaction, FileContentsQuery, ConsensusTopicCreateTransaction, KeyList, Ed25519PublicKey, ConsensusTopicId, ConsensusTopicUpdateTransaction, ConsensusTopicInfoQuery, ConsensusTopicDeleteTransaction, ConsensusMessageSubmitTransaction } from '@hashgraph/sdk';
...
var generateKeysFromMnemonics = function (mnemonics, supportsDerivation) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mnemonicsResult = Mnemonic.fromString(mnemonics);
                    return [4 /*yield*/, Ed25519PrivateKey.fromMnemonic(mnemonicsResult, "")];
                case 1:
                    rootKey = _a.sent();
...
var handleConfirmButtonClick = function (cb) { return __awaiter(void 0, void 0, void 0, function () {
...
var handleSetAccount = function (accountData, cb) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, new AccountBalanceQuery()
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, new CryptoTransferTransaction()
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!(fileReceipt.status.code === Status.Success.code)) return [3 /*break*/, 7];
                fileId = fileReceipt._fileId;
                i = 1;
                _a.label = 2;
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, new FileContentsQuery()
                        .setFileId(fileId)
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, new ConsensusTopicCreateTransaction()
                        .setTopicMemo(memo)
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = new ConsensusTopicId(topicId);
                return [4 /*yield*/, new ConsensusTopicUpdateTransaction()
                        .setTopicId(id)
                        .setAdminKey(client._operatorPublicKey)
                    // Sets memo if given
                ];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = new ConsensusTopicId(topicId);
                return [4 /*yield*/, new ConsensusTopicInfoQuery()
                        .setTopicId(id)
                        .execute(client)];
            case 1:
                topicInfo = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                client = data.client, topicId = data.topicId;
                id = new ConsensusTopicId(topicId);
                return [4 /*yield*/, new ConsensusTopicDeleteTransaction()
                        .setTopicId(id)
                        .execute(client)
                    // Fetch transaction reciept
                ];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = new ConsensusTopicId(topicId);
                return [4 /*yield*/, new ConsensusMessageSubmitTransaction()
                        .setTopicId(id)
                        .setMessage(message)
...
var exportFunctions = {
    ...
    triggerMessageSubmit: triggerSubmitMessage,
};
// Exposing inject to window object
if (util.checkEnvironment() === 'server') {
    global.hash = __assign({}, exportFunctions);
}
else {
    window.hash = __assign({}, exportFunctions);
}
var setProvider$1 = exportFunctions.setProvider;
var setProviderUI$1 = exportFunctions.setProviderUI;
var setAccount$1 = exportFunctions.setAccount;
var setAccountUI$1 = exportFunctions.setAccountUI;
var triggerCheckBalance$1 = exportFunctions.triggerCheckBalance;
var triggerCryptoTransfer$1 = exportFunctions.triggerCryptoTransfer;
var triggerSmartContract$1 = exportFunctions.triggerSmartContract;
var deploySmartContract$1 = exportFunctions.deploySmartContract;
var triggerFileCreate$1 = exportFunctions.triggerFileCreate;
var triggerFileRetrieve$1 = exportFunctions.triggerFileRetrieve;
var triggerTopicCreate$1 = exportFunctions.triggerTopicCreate;
var triggerTopicUpdate$1 = exportFunctions.triggerTopicUpdate;
var triggerTopicInfo$1 = exportFunctions.triggerTopicInfo;
var triggerTopicDelete$1 = exportFunctions.triggerTopicDelete;
var triggerMessageSubmit = exportFunctions.triggerMessageSubmit;

export { deploySmartContract$1 as deploySmartContract, setAccount$1 as setAccount, setAccountUI$1 as setAccountUI, setProvider$1 as setProvider, setProviderUI$1 as setProviderUI, triggerCheckBalance$1 as triggerCheckBalance, triggerCryptoTransfer$1 as triggerCryptoTransfer, triggerFileCreate$1 as triggerFileCreate, triggerFileRetrieve$1 as triggerFileRetrieve, triggerMessageSubmit, triggerSmartContract$1 as triggerSmartContract, triggerTopicCreate$1 as triggerTopicCreate, triggerTopicDelete$1 as triggerTopicDelete, triggerTopicInfo$1 as triggerTopicInfo, triggerTopicUpdate$1 as triggerTopicUpdate };
